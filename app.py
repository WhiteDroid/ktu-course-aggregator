...
if st.session_state.light_theme:
    ...
    <style>
        ...
        [data-testid="stVerticalBlockBorderWrapper"]:hover {
            ...
            box-shadow: 0 10px 15px -3px rgba(79, 70, 229, 0.15) !important;
    ...
    # PREMIUM LIGHT MODE CHARTS
    chart_text_color = "#334155"
    gauge_bar = "#4F46E5"          # Deep Vibrant Indigo
    gauge_bg = "#FFFFFF"
    gauge_border = "#E2E8F0"
    ...
    radar_fill = "rgba(79, 70, 229, 0.25)"
    radar_line = "#4F46E5"
    radar_bg = "rgba(241, 245, 249, 0.9)"  # Gives the radar web a solid, soft slate backdrop
    radar_grid = "#CBD5E1"
    wc_cmap = "Dark2"             # High-contrast palette perfectly visible on white
else:
    st.markdown("""
    <style>
